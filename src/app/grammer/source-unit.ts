 ...
 // This file conatain Solidity Grammer    
 
import { v4 as uuidv4 } from 'uuid';
import { DeployService } from '../services/deploy.service';

                                                                
                                     // Adds logs in the counsole 
class BaseItem {
    uuid: string = "";
    name: string = "";
    output: string = "";
...
class Pragma extends BaseItem {
    ...
    override generateStatement(): string {           // Pragma statment 
        if(this.token) {
...
class Comment extends BaseItem {
    ...
    override generateStatement(): string {
        if(this.text) {
            this.output = "// " + this.text;                // Comment structer define. 
        }
        return this.output;
    }
}
...
class ABICoderPragma extends BaseItem {               // Application Binary Code Interface 
...
class Contract extends BaseItem {
    ...
    override generateStatement(): string {
        ...
        return this.output;
                                         ...
                                         // Includes interface in the code 
...
class Constructor extends BaseItem {            // creates Construtors 
