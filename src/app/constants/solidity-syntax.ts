import { License, Pragma, Comment, Version, ABICoderPragma, Import, 
    ...
    Modifier, Fallback, Receive, UserDefinedValueType,  Event, Error, Using, Function, Parameter, Block, IfStatement} 
    from "../grammer/source-unit";
                                          
                                                 //This file contains constanst components of Solidity - 
const FileItems: any[] = [
...
const ContractItems: any[] = [ 
    ...
    new Error(), new Using() , new IfStatement(),
];
