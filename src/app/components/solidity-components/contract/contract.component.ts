...
import { BaseItem, Comment, Constructor, Contract, Enum, Error, Event, Fallback, Function, IfStatement, Modifier, Receive, StateVariable, Struct, UserDefinedValueType, Using, Variable } from 'src/app/grammer/source-unit';
    ...
    if (event.previousContainer === event.container) {
      ...
      switch(event.previousContainer.data[event.previousIndex].name) {
        ...
        case "Using":
          ...
          break;
        case "IfStatement":
          this.item.elements?.push(new IfStatement());
        break;
      }
    }
  }
